...
IMAGES = [
    ...
    ("rio_entre_pedras", "Rio entre Pedras", ["water", "root"], ["gentle", "grounded"],
     ...
     "https://images.unsplash.com/photo-1437482078695-73f5ca6c96e3?q=80&w=800&auto=format&fit=crop"),
    ...
    ("caverna_do_silencio", "Caverna do Silêncio", ["ether", "night"], ["deep", "dark"],
     ...
     "https://images.unsplash.com/photo-1444858291040-58f756a3bdd6?q=80&w=800&auto=format&fit=crop"),
    ...
    ("tempestade_raio", "Tempestade de Raios", ["fire", "sky"], ["vast", "intense"],
     ...
     "https://images.unsplash.com/photo-1461511663015-0a700dd4c11f?q=80&w=800&auto=format&fit=crop"),
    ...
    try:
        ...
        for entry in manifest:
            ...
            audio = AudioAsset(
                ...
                cdn_url=f"https://aurasync-production.up.railway.app/media/audio/{entry['file']}",
                format="wav",
        ...
        for title, desc, axes, moods, duration, audio_file, cdn_url in MEDITATION_ITEMS:
            ...
            audio = AudioAsset(
                ...
                cdn_url=f"https://aurasync-production.up.railway.app/media/audio/{audio_file}",
